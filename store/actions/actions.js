...
const openCloseModal = (payload ) =>{
    return { 
        type: payload.type,
        payload: payload.payload
    }
};
export { doAddPopularMovies, doFetchMovies, doAddTopRatedMovies, showSelectedMovie, doAddMovieConfig, receiveConfig, doAddMovieDetails, openCloseModal }